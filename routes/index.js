...
router.delete('/productos/eliminar/:id',(req,res) => controllers.deleteProduct(req,res));
...
router.delete('/categoria/eliminar/:id',(req,res) => controllers.deleteCategory(req,res));
